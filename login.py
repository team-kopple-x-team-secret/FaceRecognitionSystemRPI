...
class Login:
    def __init__(self):
        ...
        self.username_entry = tk.Entry(self.root, width=30, bg="#D9D9D9", bd=0, highlightthickness=0, font=font_style)
        self.username_entry.place(x=571, y=288, width=316, height=60)

        self.password_entry = tk.Entry(self.root, show="*", width=30, bg="#D9D9D9", bd=0, highlightthickness=0, font=font_style)
        self.password_entry.place(x=571, y=384, width=316, height=60)

        login_button = tk.Button(self.root, text="Login", bg="#3E806E", fg="#D9D9D9", bd=0, highlightthickness=0, font=font_style, command=self.login)
